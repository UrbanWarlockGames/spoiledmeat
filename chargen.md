...
**Table of Contents**
  ...
  - [Skills](#skills)
    ...
    - [Archetype Skills](#archetype-skills)
      - [Woodsman](#woodsman)
...
- Mental: Knowledge, Perception, Willpower
...
#### Woodsman
*The Woodsman is a druid old in his years and stuck in his ways. He wants to be out in the woods, away from the city. He doesn't like being brought to the city and having to deal with things like NOISE, POLLUTION, and POLITICS. He believes things would be better if we RETURNED TO THE OLD WAYS. Before newfangled inventions like WATERMILLS and STEAM ENGINES turned the RIVERLANDS into MOTORWAYS.*
...
### Class Templates
 - Warrior [MIG]: 
 - Mage [KNO]
  - Abjurer/Protection Mage: 
  - Diviner: 
  - Elocater/Portal Mage: 
  - Enchanter/Charm Mage: 
  - Evoker/Battlemage: 
  - Illusionist: 
  - Synergist/Alteration Mage: variety of spells that buff allies, can use the Synergise reaction to use Elemental Fusion action with an ally's elemental spell of equal spell rank
 - Specialist [PER]: skills equal to PER instead of KNO. have access to specialist skills
 - Priest [WILL]: an unarmoured class focused on healing allies and curing conditions. may use an amount of Luck in 6 for divine intervention.
 - Barbarian [MIG]: use Focus to increase damage = HD + MIG
 - Paladin [CHA]: use Focus to heal = HD + CHA
 - Shieldbearer [FIT]: wields shield as a weapon, use Focus to resist damage = HD + FIT
 - Elementalist [CHA]: control (move, amplify, or nullify) and generate an element using focus points [HD m²/HD damage/focus point], unique elementalist abilities
 - Spellsword [MIG]: cast spell using weapon attack roll, add 1/2 weapon damage + spell effect (single target only until level 5)
 - Artificer [KNO]: ¯\_(ツ)_/¯
 - Adept [KNO]: see *spellcrafting rules (wip)*
 - Shifter [FIT]: ¯\_(ツ)_/¯
 - Summoner [LEA]: specialise in elementals, fiends, aberrations, undead, beasts, vermin, dragons, plants, oozes, or constructs
 - Officer [LEA]: warlord commander tactician
 - Alchemist [KNO]: ¯\_(ツ)_/¯
...
### Elemental
 - Flames (burns; can melt ice on hit, removing the Frozen critical effect, turn Cold to Wet, remove Wet; critical effect: Ignite 1 flames damage/t)
...
### Magical
 ...
 - Psychic (mental or non-visible damage, cringe; always targets morale pool before health pool)

### Metaphysical
 - Aberrant (otherworldly, eldritch, changing; always targets morale pool before health pool)
...
### Physical
#### Crushing
 - Vulnerability Condition: Broken Bones (Limbs become broken on Critical hit leaving them unusable. Head or Torso hit leaves the Target Stunned until Helped)
 - Nullified by: Restoration

#### Slashing
 - Vulnerability Condition: Bleeding (d4 Slashing damage each turn until DC 6 Heal check is made)
 - Amplified by: Bleeding, Impaled
 - Nullified by: Fire

#### Piercing
 - Vulnerability Condition: Impaled (-2 Critical Threat Range)
 - Amplified by: Impaled
 - Nullified by: Restoration

#### Ballistic
 - Vulnerability Condition: Blown Apart (+1D Critical damage)
...
#### Toxic
 - Vulnerability Condition: Clock 6 (-2/Toxic rank), Blighted (after 2d4 days, [x= Toxic level]d4 Toxic damage each minute)
 - Amplified by: Blighted
 - Reduced by: Heal action (min = Toxic rank) 
 - Nullified by: Greater Restoration

#### Psychic
 - Vulnerability Condition: Stupefied (cannot cast spells for rank duration, bane equal to rank on all Knowledge and Will-based tasks, if >III: cannot take any actions with the Mental trait)
 - Amplified by: Stupefied
 - Reduced by: Leadership

### Metaphysical
#### Holy
 - Vulnerability Condition: Holy Flames (you cannot receive the effects of healing)
 - Nullified by: Greater Restoration
...
## Elemental Tags
 ...
 - Metal; 
 - Dust; 
 - Smoke; deals Suffocation damage if all hexes in room become Smokey and makes all creatures within Smokey terrain Concealed unless they have smokesight or non-sight senses. Smokey terrain makes creatures Hidden instead of Concealed to characters with infravision.
 - Ash; 
 - Vapour; makes character in area Wet but not Terrain
 - Slime; 
 - Oil; gives Flammable (Ignite on flames hit)
...
### Demihuman Templates
 ...
 - Catfolk
 - Dogbold
 - Lupin (Corgi/Cor Gŵn[Corgoon], Cú Faoil/Coin Fhaoil[Quefeel/Quineel], Cyfergi/Cyfergŵn[Kivergoon], Daeargi, Gafaelgi/Gafaelgŵn[Gafaelgi], Hen Gi/Hen Gŵn[Hen Gi], Ci Hela/Cŵn Hela[Cunella], Blaidd/Bleiddiaid[Blatheid]
 - Gnoll
 - Minotaur
